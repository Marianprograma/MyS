...
public class App {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<50;i++){
            new AirportSim(SIMULATION_LENGHT, ScenarioBuilder.multipleServersOneQueue(1,2,2), new MultipleServerSelectionPolicy(), new CustomRandomizer(),report,customReportTotal).run();
            report.resetCustom();
        }
